...
enhanced_audio_path = "data_path/4ch-4spk/anechoic/test/IVA-Gauss.txt"

number_of_audio = 6000
...
with open(target_audio_path, 'r') as target_files, \
    ...
    with open(os.path.join(eval_save_dir, "test_iva_imp_gauss50.json"), "w") as f:
