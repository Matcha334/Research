...
path_to_original_audio_files = "data_path/4ch-2spk/IVA/test/IVA-Gauss.txt"
path_to_enhanced_audio_files = "data_path/4ch-2spk/Observe/test/s1.txt"
path_to_mixture_audio_files = "data_path/4ch-2spk/Observe/test/2spk-mix.txt"
...
with open(os.path.join(eval_save_dir, "iva_angel_perf"), "w") as f:
